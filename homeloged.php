...
<body>
  ...
  <header>
    ...
    <div class="nav-buttons">
        <p class="hellousername">Olá, <?php echo $nome; ?>!</p>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="pagina1.php">Regulamentação</a></li>
                <li><a href="pagina2.php">Inscreva seu condomínio</a></li>
                <li><a href="pagina3.php">Sou jogador</a></li>
                <li><a href="pagina3.php">Sobre nós</a></li>
            </ul>
        </div>
    </div>
</header>
